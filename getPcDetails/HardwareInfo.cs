...
namespace GetPcDetails
{
    public static class HardwareInfo
    {
        ...
        public static string[] GetUsersList()
        {
            ...
            {
                list.Add((string)envVar["Name"]);
            }
            String[] str = list.ToArray();
            return str;
        }

        public static string[] GetSoftwareList()
        {
            
            List<string> softwareListlist = new List<string>();
                ...
                foreach (string skName in rk.GetSubKeyNames())
                {
                    using (RegistryKey sk = rk.OpenSubKey(skName))
                    {
                        try
                        {
                            ...
                            if (displayName != null)
                            {
                                softwareListlist.Add((string)displayName);
                            }
                        }
                        catch (Exception ex)
                        { }
            ...
            String[] softwareListlistStr = softwareListlist.ToArray();
            return softwareListlistStr;
        }
        ...
        {
            return Utils.RunCmd(@"ipconfig /all");
        }

        public static string PingGoogle()
        {
            return Utils.RunCmd(@"ping google.co.il");
        }
    }
}
